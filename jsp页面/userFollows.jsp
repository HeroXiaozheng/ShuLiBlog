	...
	<body>
          ...
          <c:forEach items="${authorpagelist}" var="follows" varStatus="status">
            ...
            <div class="popular-post-grid">
                  <a href="userpage?userid=${follows.follow.userid}" target="_blank"><img src="myimg?userid=${follows.follow.userid}"  style="width:60px;height:60px;"/></a>
                  <a class="author-name" href="userpage?userid=${follows.follow.userid}" target="_blank">
                  <c:choose>
                  	<c:when test="${follows.username!=null }">
                  		<c:choose>
                  	    	 <c:when test="${follows.follow.userid!=sessionScope.userid}">
                    			${follows.username}
                    		</c:when>
                ...
                <a id="follow${follows.follow.userid }" class="sendmsg" style="position:fixed;left:500px;cursor: pointer;" onclick="follow('${sessionScope.userid }','${follows.follow.userid}')">
